...
import type { HasSpuResponseData, Records, SkuInfoData, SkuData } from '@/views/product/spu/type'
import { ref, watch, onBeforeUnmount } from 'vue';
import { reqHasSpu, reqSkuList, reqRemoveSpu } from '@/views/product/spu';
//引入分类的仓库
...
// 和之前的一样 最好不要用这两个事件 因为后续版本可能就改名了@current-change@size-change，还是用监听比较好  watch([pageNo, pageSize], () => {   getHasSpu(pageNo.value) })
watch([pageNo, pageSize], () => { getHasSpu(pageNo.value) })
